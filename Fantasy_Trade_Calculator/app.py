...
Reads static weekly snapshot JSON (webapp/data/, written by generate_snapshot.py --
never pulled live here). The only live calls this app makes are to Sleeper's public
API, and only when a user actively syncs a league in Tab 3.
"""
import json
