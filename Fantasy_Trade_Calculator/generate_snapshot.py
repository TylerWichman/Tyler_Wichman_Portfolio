...
writes static JSON output under webapp/data/ -- the Streamlit app reads only these
files at request time, so no site visitor ever triggers a live FantasyCalc/KTC/CFBD
pull. This script is the only place those live pulls happen.
"""
import json
import os
import sys
...
# trade_calculator_pipeline.py lives one directory up from webapp/.
